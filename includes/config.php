...
return array(
    ...
    'upload' => array(
        ...
        'max_file_size'    => 5242880, // 2 * 1024 * 1024 // 2mb
    ),
    /**
    ...
    'postimage' => array(
        ...
        'accounts' => array(
            //  array(
            //     'username' => 'kunproyeuem@gmail.com',
            //     'password' => 'M$fC#vWz82JSM26',
            //  ),
            // array(
            //     'username' => 'user1',
            //     'password' => 'pass1',
    ...
    'imageshack' => array(
         ...
         */
        'api_keys' => array(
            '0CGHIJLT606915852c5ebcf970d5a1dd91f24116',
            // 'other API',
            // 'other API',
        ),
        /**
    ...
    'imgur' => array(
        ...
        'api_keys' => array(
            array(
                'key'    => '8b15ab7179a28d9', // Client ID
                'secret' => 'e3197fa96d57ff81cd93ec0d577ed257f3fb45d7', // Client secret
            ),
            /**
    ...
    'picasanew' => array(
        ...
        'api_keys' => array(
            ...
            array(
                'key'      => '790763478510-k114ar96s0go2lfpokbjk4bcr6u5b1dc.apps.googleusercontent.com',
                'secret'   => 'QzdRicSzO0UqA4rPEqPT1-WP',
            ),
        ),
        'accounts' => array(
            // Không cần password, chỉ cần username
            array(
                'username' => 'kunproyeuem',
                /**
    ...
    'flickr' => array(
        ...
        'api_keys' => array(
            array(
                'key'    => 'ec384fb15b7cac1da2fc0db37bdeb379',
                'secret' => '6d671ddff8a4c54a',
            ),
            /**
             * Có thể thêm nhiều account khác theo mẫu tương tự bên dưới
             */
